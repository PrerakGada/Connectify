...
import '../../models/apointer_editor.dart';
...
class ShiftScheduler extends SampleView {
  ...
  ShiftScheduler({Key? key}) : super(key: key);
...
class _ShiftSchedulerState extends SampleViewState {
  ...
  void _addResourceDetails() {
    ...
    _nameCollection.add('Siddesh');

    _userImages.add('assets/People_Circle5.png');
    _userImages.add('assets/People_Circle8.png');
    _userImages.add('assets/People_Circle18.png');
    _userImages.add('assets/People_Circle23.png');
    _userImages.add('assets/People_Circle25.png');
    _userImages.add('assets/People_Circle20.png');
    _userImages.add('assets/People_Circle13.png');
    _userImages.add('assets/People_Circle11.png');
    _userImages.add('assets/People_Circle27.png');
    _userImages.add('assets/People_Circle26.png');
    _userImages.add('assets/People_Circle24.png');
    _userImages.add('assets/People_Circle15.png');
  }

  /// Creates the required appointment details as a list.
  void _addAppointmentDetails() {
    _subjectCollection.add('General Meeting');
    _subjectCollection.add('Interview');
    ...
    _subjectCollection.add('Interview Scheduled');
